        ...
        <tbody>
            ...
            $no++;?><!-- punya adel -->
                <tr>
                    ...
                    <td><a href="ubah_admin.php?id_admin=<?php echo $dt_admin['id_admin']; ?>" class="btn btn-success">Ubah</a> | <a href="hapus_admin.php?id_admin=<?php echo $dt_admin['id_admin']; ?>" onclick="return confirm('Apakah anda yakin menghapus data ini?')" class="btn btn-danger">Hapus</a></td>
                </tr>
                <?php
                }
                ?>
