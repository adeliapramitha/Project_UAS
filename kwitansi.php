...
<!--KWITANSI -->
<a href="tambah_kwitansi.php" class="btn btn-success">Tambah Data</a>
    ...
    <table class="table table-hover table-striped">
        ...
        <tbody>
            <?php
            include "koneksi.php";
            $qry_kwitansi=mysqli_query($conn,"select * from kwitansi");
            $no=0;
            while($dt_kwitansi=mysqli_fetch_array($qry_kwitansi)){
            $no++;?><!-- punya adel -->
                <tr>
                    <td><?=$no?></td><td><?=$dt_kwitansi['tgl_kwt']?></td> <td><?=$dt_kwitansi['dari']?></td><td><?=$dt_kwitansi['untuk']?></td><td><?=$dt_kwitansi['jumlah']?></td><td><?=$dt_kwitansi['terbilang']?></td><td><?=$dt_kwitansi['penerima']?></td>
                    <td><a href="ubah_kwitansi.php?id_kwitansi=<?php echo $dt_kwitansi['id_kwitansi']; ?>" class="btn btn-success">Ubah</a> | <a href="hapus_kwitansi.php?id_kwitansi=<?php echo $dt_kwitansi['id_kwitansi']; ?>" onclick="return confirm('Apakah anda yakin menghapus data ini?')" class="btn btn-danger">Hapus</a></td>
                </tr>
                <?php
                }
                ?>
