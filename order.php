...
<?php
  ...
  <a href="tambah_order.php" class="btn btn-success">Tambah Data</a>
            ...
            $no++;?><!-- punya adel -->
                <tr>
                    <td><?=$no?></td><td><?=$dt_sewa['merk']?></td> <td><?=$dt_sewa['jenis']?></td><td><?=$dt_sewa['nama_sewa']?></td><td><?=$dt_sewa['ktp']?></td><td><?=$dt_sewa['tgl_sewa']?></td><td><?=$dt_sewa['tgl_kembali']?></td><td><?=$dt_sewa['lama']?></td><td><?=$dt_sewa['harga_total']?></td>
                     <td><a href="ubah_order.php?id_sewa=<?php echo $dt_sewa['id_sewa']; ?>" class="btn btn-success">Ubah</a> 
                        <a href="hapus_order.php?id_sewa=<?php echo $dt_sewa['id_sewa']; ?>" onclick="return confirm('Apakah anda yakin menghapus data ini?')" class="btn btn-danger">Hapus</a></td>
                </tr>
                <?php
                }
                ?>
