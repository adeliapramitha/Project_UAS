...
<!-- SEPEDA -->
<h3 align="center">DATA SEPEDA</h3>
  <a href="tambah_sepeda.php" class="btn btn-success">Tambah Data</a>
        ...
        <tbody>
            ...
            $no++;?><!-- punya adel -->
                <tr>
                    ...
                    <td><a href="ubah_sepeda.php?id_sepeda=<?php echo $dt_sepeda['id_sepeda']; ?>" class="btn btn-success">Ubah</a> | <a href="hapus_sepeda.php?id_sepeda=<?php echo $dt_sepeda['id_sepeda']; ?>" onclick="return confirm('Apakah anda yakin menghapus data ini?')" class="btn btn-danger">Hapus</a></td>
                </tr>
                <?php
                }
                ?>
