...
<!--KWITANSI -->
    <h5 class="card-header" align="center">Tambah Kwitansi</h5>
            <div class="card-body">
        <form method="post" action="proses_tambah_kwitansi.php">
          <div class="form-group">
            <label>Tanggal Kwitansi</label>
            <input type="date" class="form-control" name="tgl_kwt">
          </div>
          <div class="form-group">
          ...
          <div class="form-group">
            ...
            <input type="text" class="form-control" name="jumlah" value="Rp ">
          </div>  
          <div class="form-group">
