                ...
                <div class="container my-5 py-5 px-lg-5">
                    <div class="row g-5 py-5">
                        <div class="col-12 text-center">
                            <h1 class="text-white animated slideInDown">Order</h1>
...
<!-- ORDER -->
 <?php
    ...
    ?>
      <div class="card">
        <h5 class="card-header" align="center">Tambah Sewa</h5>
            <div class="card-body">
        <form method="post" action="proses_tambah_order.php">
          <div class="form-group">
            <label>Sepeda</label>
             <select name="mj" class="form-control">
            <option value="">--- Pilih ---</option>
           <?php
              while ($dt_sepeda = mysqli_fetch_array($qry_sepeda)) {
           ?>
           <option value="<?php echo $dt_sepeda['id_sepeda']; ?>"><?php echo $dt_sepeda['merk'] . " - " . $dt_sepeda['jenis']; ?></option>
          <?php
        }
          ?>
            </select>
          ...
          <div class="form-group">
            ...
            <input type="text" class="form-control" name="nama_sewa">
          </div>  
          <div class="form-group">
            <label>No KTP</label>
           ...
           <div class="form-group">
            ...
            <select name="jk_sewa" class="form-control">
            <option></option>
          ...
          <div class="form-group">
            ...
            <input type="text" class="form-control" name="telp_sewa">
          </div>
          <div class="form-group">
