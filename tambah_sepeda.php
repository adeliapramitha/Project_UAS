...
<!-- SEPEDA -->
<div class="card">
        <h5 class="card-header" align="center">Tambah Sepeda</h5>
            <div class="card-body">
        <form method="post" action="proses_tambah_sepeda.php">
          <div class="form-group">
            ...
            <option value="Avand">Avand</option>
            </select>
          </div>
           <div class="form-group">
            <label>Jenis</label>
            ...
            <option value="CTB">Sepeda CTB</option>
            </select>
          </div>
          <div class="form-group">
            <label>Harga</label>
          ...
          <div class="form-group">
            ...
            <input type="text" class="form-control" name="s_sepeda">
          </div>
