                ...
                <div class="container my-5 py-5 px-lg-5">
                    <div class="row g-5 py-5">
                        <div class="col-12 text-center">
                            <h1 class="text-white animated slideInDown">Sepeda</h1>
                            <hr class="bg-white mx-auto mt-0" style="width: 90px;">
                            <nav aria-label="breadcrumb">
                                <ol class="breadcrumb justify-content-center">
                                    <li class="breadcrumb-item"><a class="text-white" href="#">Home</a></li>
                                    <li class="breadcrumb-item"><a class="text-white" href="#">Pages</a></li>
                                    <li class="breadcrumb-item text-white active" aria-current="page">Sepeda</li>
                                </ol>
                            </nav>
                        </div>
                    </div>
...
<!-- SEPEDA -->
<div class="card">
        <h5 class="card-header" align="center">Ubah Data Sepeda</h5>
            <div class="card-body">
        <form method="post" action="proses_ubah_sepeda.php">
            <?php
                include 'koneksi.php';
                $id_sepeda=$_GET['id_sepeda'];
                $qry_get_sepeda = mysqli_query($conn, "select * from sepeda where id_sepeda='".$_GET['id_sepeda']."'") or die(mysqli_error());
                $dt_sepeda=mysqli_fetch_array($qry_get_sepeda);
            ?>
        <input type="hidden" name="id_sepeda" value= "<?=$dt_sepeda['id_sepeda']?>">
          <div class="form-group">
            <label>Merk</label>
            <input type="text" name="merk" value= "<?=$dt_sepeda['merk']?>" class="form-control">
          </div>
           <div class="form-group">
            <label>Jenis Sepeda</label>
            <?php
            $arr_jenis=array('Hybrid' => 'Sepeda Hybrid', 'Lipat' => 'Sepeda Lipat', 'Gunung' => 'Sepeda Gunung', 'Fixie' => 'Sepeda Fixie', 'CTB' => 'Sepeda CTB');
        ?>
        <select name="jenis" class="form-control">
            <option></option>
            <?php foreach ($arr_jenis as $key_jenis => $val_jenis):
                if($key_jenis==$dt_sepeda['jenis']){
                    $selek="selected";
            } else {
                $selek="";
            }
          ...
          <div class="form-group">
            <label>Harga</label>
            <input type="text" name="harga" value= "<?=$dt_sepeda['harga']?>" class="form-control">
          </div>  
          <div class="form-group">
            <label>Status Sepeda</label>
            <input type="text" name="s_sepeda" value= "<?=$dt_sepeda['s_sepeda']?>" class="form-control">
          </div>
